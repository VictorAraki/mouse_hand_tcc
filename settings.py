...
def set_env_var():
    ...
    os.environ['MouseSensibility_X'] = '1.1' # Float, sensibilidade da escala da tela em X
    os.environ['MouseSensibility_Y'] = '1.1' # Float, sensibilidade da escala da tela em Y
