...
def set_env_var():
    ...
    """
    os.environ['MousePointerPoint'] = '8' # Integer, ponto da mao que sera usado como ponteiro do mouse
    ...
    os.environ['MouseClickRef'] = '12' # Integer, ponto da mao que se aproximada da ref gerara o click
